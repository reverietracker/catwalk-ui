...
class Input extends Component {
    constructor(options) {
        ...
        this.modelChangeHandler = (newValue) => {
    ...
    trackModel(model) {
        if (this.model) {
            this.model.removeListener(this.changeEvent, this.modelChangeHandler);
        }
        this.model = model;
        this.model.on(this.changeEvent, this.modelChangeHandler);
        this.renderValue(this.model[this.property]);
    }
